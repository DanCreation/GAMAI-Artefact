/////////////////////////////////////////////////////////////////////////////// All Of This Code Is From Moodle Except For The Lines I Have Marked //////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                              /////////////////////////////////////////////////////////////////////
...
public class FieldOfView : MonoBehaviour
{
    ...
    public bool seePlayer = false; // I added this line
    ...
    void FindVisibleTargets()
    {
        ...
        foreach (Collider target in targets)
        {
            ...
            if(Vector3.Angle(transform.forward, toTargetNormalized) < viewAngle / 2 && !Physics.Raycast(transform.position, toTargetNormalized, toTarget.magnitude, obstacleLayer))
            {
